...
export default function SearchBar({ setQuery, Query, onSearchClick }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex items-center justify-between bg-red-500">
      <CgSearch className="w-[2rem] h-[2rem] m-2" />
      <input
        className="w-[100%] bg-transparent border-none outline-none px-4 py-2 placeholder:text-lg text-gray-300"
        type="search"
        value={Query}
