...
export default function SideBar() {
  return (
    <div className="  h-full flex flex-row md:flex-col  rounded-md  items-center justify-between bg-[#1d2741e6] bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20 md:px-2 md:py-0 py-4 m-0 sm:m-4  md:mr-0 sm:mb-0 sticky">
